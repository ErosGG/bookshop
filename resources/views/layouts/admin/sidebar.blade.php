...
<div class="vh-100 sticky-top d-flex flex-column flex-shrink-0 p-3 bg-dark text-white" style="width: 280px;">
    ...
    <a href="/" class="d-flex align-items-center me-md-auto text-white text-decoration-none">
        ...
        <span class="fs-4">llibreria.cat</span>
    </a>
    <hr>
    {{--            <ul class="nav nav-pills flex-column mt-2 pt-3 mb-auto">--}}
    <ul class="nav nav-pills flex-column mt-4 mb-auto">
        <li class="nav-item">
            <a href="{{ route('admin.dashboard.index') }}" class="d-flex align-items-center nav-link text-white fs-5 @if($section === 'dashboard'){{ 'active' }}@endif" aria-current="page">
        ...
        <li>
            <a href="{{ route('admin.categories.index') }}" class="d-flex align-items-center nav-link text-white fs-5 @if($section === 'categories'){{ 'active' }}@endif">
                <svg style="margin-left: 10px; margin-right: 10px;"
                     xmlns="http://www.w3.org/2000/svg" width="32" height="27" fill="currentColor"  viewBox="0 0 16 16"
        ...
        <li>
            <a href="{{ route('admin.products.index') }}" class="d-flex align-items-center nav-link text-white fs-5 @if($section === 'products'){{ 'active' }}@endif">
                <svg style="margin-left: 10px; margin-right: 10px;"
                     xmlns="http://www.w3.org/2000/svg" width="32" height="27" fill="currentColor"  viewBox="0 0 16 16"
                     class="bi bi-diagram-3"
                >
        ...
        <li>
            <a href="{{ route('admin.orders.index') }}" class="d-flex align-items-center nav-link text-white fs-5 @if($section === 'orders'){{ 'active' }}@endif">
                <svg style="margin-left: 10px; margin-right: 10px;"
                     xmlns="http://www.w3.org/2000/svg" width="32" height="27" fill="currentColor"  viewBox="0 0 16 16"
                     class="bi bi-receipt"
                >
